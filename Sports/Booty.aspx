<%@ Page Title="" Language="C#" MasterPageFile="~/NestedSport.master" AutoEventWireup="true" CodeFile="Booty.aspx.cs" Inherits="Sports_Booty" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="TeacherImageContentPlaceHolder" runat="server">
    <img src="../Images/bootyCoach.jpg" alt="SportTeacher" class="ImageTeacherSport"/>
</asp:Content>
...
<asp:Content ID="Content7" ContentPlaceHolderID="Picture1ContentPlaceHolder" runat="server">
    <img src="../Images/booty1.jpg" alt="SportTeacher" class="sportPicture"/>
</asp:Content>
<asp:Content ID="Content8" ContentPlaceHolderID="Picture2ContentPlaceHolder" runat="server">
    <img src="../Images/booty2.jpg" alt="SportTeacher" class="sportPicture"/>
</asp:Content>
...
<asp:Content ID="chat" ContentPlaceHolderID="ChatPlaceHolder" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
         SelectCommand="SELECT Id as id,username as username, message as message FROM [chatmessage] WHERE sportname='Booty' ORDER BY id" />
